...
class DenseNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out_after_pooling = F.avg_pool2d(
...
class DenseNet121(nn.Module):
    ...
    def __init__(self, out_size):
        ...
        self.densenet121 = Densenet121_AG(pretrained=True)
...
class CovidAidAttend(DenseNet121):
    def __init__(self, combine_pneumonia):
        NUM_CLASSES = 3 if combine_pneumonia else 4
        super(CovidAidAttend, self).__init__(NUM_CLASSES)
